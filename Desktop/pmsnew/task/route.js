...
const taskregistrationController = require('./controller');
 ...
 */
router.post('/task',taskregistrationController.createTask);
...
router.put('/update-task',taskregistrationController.updateTask)
